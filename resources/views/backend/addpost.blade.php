        ...
        <div class="row">
            <div class="col-xs-12 col-md-12 col-lg-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">Thêm bai viet</div>
                            ...
                            <div class="row" style="margin-bottom:40px">
                                  <div class="col-xs-8">
                                    <div class="form-group" >
                                        <label>title</label>
                                        <input required type="text" id="title" name="title" value="" class="form-control">
                                    </div>
                                    <div class="form-group" >
                                        <label>content</label>
                                    ...
                                    <div class="form-group" >
                                       <label>hot</label>
                                        <select name="hot" id="hot" class="form-control">
                                            ...
                                            <option value="1">Tin khong hot</option>
                                        </select>
                                    </div>
